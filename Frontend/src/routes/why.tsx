  ...
  head: () => ({
    meta: [
      { title: "Why RailConnect — Fast, Secure, Paperless Rail Tickets" },
      {
        name: "description",
        content:
          "Discover why commuters choose RailConnect for fast, secure, paperless railway ticketing.",
      },
      { property: "og:title", content: "Why RailConnect" },
      {
        property: "og:description",
        content: "Fast, secure and paperless railway ticketing designed for modern commuters.",
      },
    ],
  }),
  component: WhyPage,
...
const FEATURES = [
  {
    icon: "🚆",
    t: "Book in Seconds",
    d: "Book Journey Tickets and Platform Tickets within seconds.",
  },
  { icon: "📱", t: "Paperless Travel", d: "Travel securely using QR-based digital tickets." },
  {
    icon: "💳",
    t: "Smart Wallet",
    d: "Recharge wallet, pay for tickets and receive instant refunds.",
  },
  { icon: "🔄", t: "Quick Refunds", d: "Automatic refund calculations with wallet credit." },
  {
    icon: "🔔",
    t: "Real-Time Notifications",
    d: "Receive instant updates about bookings, payments and refunds.",
  },
  {
    icon: "📍",
    t: "Smart Station Search",
    d: "Fast autocomplete station search with intelligent suggestions.",
  },
];
          ...
          <div className="glass grid grid-cols-2 gap-4 rounded-3xl p-6 shadow-soft sm:p-10 md:grid-cols-4">
            {STATS.map((s) => (
              <div key={s.l} className="rounded-2xl bg-white/70 p-5 text-center">
                <div className="text-railway-gradient font-[Sora] text-3xl font-extrabold sm:text-4xl">
                  {s.v}
                </div>
