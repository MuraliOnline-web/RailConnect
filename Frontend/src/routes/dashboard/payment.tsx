...
const GooglePayLogo = () => (
  <svg viewBox="0 0 45 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4.5 w-auto">
    <path d="M7.74 3.75c0-.26-.02-.51-.07-.76H0v1.44h4.34c-.19 1-.75 1.84-1.6 2.41v2h2.58c1.51-1.4 2.38-3.46 2.38-5.09z" fill="#4285F4"/>
    <path d="M3.75 8.16A4.95 4.95 0 0 1 0 9.75v1.43c2.72 0 5-1.8 5.76-4.22H3.75z" fill="#34A853"/>
    <path d="M0.95 4.54A3 3 0 0 0 0.95 8l1.6 1.25A5 5 0 0 1 0.95 3.3L2.55 2.05A4.9 4.9 0 0 1 3.75 4.54z" fill="#FBBC05"/>
    <path d="M3.75 3.75c-.76-2.42-3.04-4.22-5.76-4.22v1.43c1.7 0 3.19 1.1 3.75 2.79h1.68l.33-1.07-.33 1.07z" fill="#EA4335"/>
    <text x="17" y="11.5" fontFamily="sans-serif" fontWeight="bold" fontSize="10.5" fill="#5F6368">Pay</text>
  </svg>
);
...
const PhonePeLogo = () => (
  <svg viewBox="0 0 45 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-auto">
    ...
    <path d="M11 4h-1.5c-.8 0-1.5.7-1.5 1.5v7c0 .8.7 1.5 1.5 1.5H11c.8 0 1.5-.7 1.5-1.5v-7c0-.8-.7-1.5-1.5-1.5zm-.8 8.5c-.7 0-1.2-.5-1.2-1.2s.5-1.2 1.2-1.2 1.2.5 1.2 1.2-.5 1.2-1.2 1.2zm0-4c-.7 0-1.2-.5-1.2-1.2s.5-1.2 1.2-1.2 1.2.5 1.2 1.2-.5 1.2-1.2 1.2z" fill="#ffffff"/>
    <text x="16.5" y="11.8" fontFamily="sans-serif" fontWeight="bold" fontSize="7" fill="#ffffff">PhonePe</text>
  </svg>
);

const PaytmLogo = () => (
  <svg viewBox="0 0 45 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-auto">
    <text x="2" y="13" fontFamily="sans-serif" fontWeight="bold" fontSize="13" fill="#00baf2">pay</text>
    <text x="22" y="13" fontFamily="sans-serif" fontWeight="bold" fontSize="13" fill="#002e6e">tm</text>
  </svg>
);
...
const BhimLogo = () => (
  <svg viewBox="0 0 45 18" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-4 w-auto">
    ...
    <text x="10.5" y="10.5" fontFamily="sans-serif" fontWeight="900" fontSize="8" fill="#0072B8">BHIM</text>
    <text x="10.5" y="15.5" fontFamily="sans-serif" fontWeight="bold" fontSize="5" fill="#F48221">UPI</text>
  </svg>
);
...
const WalletLogo = () => (
  <svg viewBox="0 0 45 28" fill="none" xmlns="http://www.w3.org/2000/svg" className="h-5.5 w-auto">
    ...
    <path d="M11 8h23a1.5 1.5 0 0 1 1.5 1.5v9a1.5 1.5 0 0 1-1.5 1.5H11a1.5 1.5 0 0 1-1.5-1.5v-9A1.5 1.5 0 0 1 11 8zm23 3.5h-5a1 1 0 1 0 0 2h5v-2z" fill="#ffffff"/>
  </svg>
);
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-xs font-bold uppercase tracking-wider text-orange-950/80">
      {children}
    </div>
  );
}
