...
function ProfilePage() {
  ...
  return (
    <DashboardShell>
      ...
      <p className="mt-1 text-sm text-muted-foreground">Manage your RailConnect account, security and travel preferences.</p>
      ...
      <div className="mt-6 grid gap-5 lg:grid-cols-3">
        <div className="glass rounded-3xl p-6 text-center shadow-soft">
          ...
          <button
            ...
            className="mt-5 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-white px-4 py-2 text-xs font-semibold text-orange-700 transition hover:bg-orange-50"
          >
        ...
        <Section title="Security" icon={<FaLock />}>
          ...
          <button
            onClick={() => { logout(); navigate({ to: "/" }); }}
            className="mt-1 flex w-full items-center justify-between rounded-xl bg-rose-50 px-4 py-3 text-left text-sm font-semibold text-rose-700"
          >
        ...
        <Section title="Travel preferences" icon={<FaTrainSubway />}>
          <ActionRow label="Favorite routes" desc="Saved for one-tap booking" to="/dashboard/favorites" />
        ...
        <Section title="App settings" icon={<FaSliders />}>
          ...
          <ActionRow label="Notifications" desc="Booking, journey, offers" to="/dashboard/settings" />
          <ActionRow label="Theme & accessibility" desc="Light · Standard" to="/dashboard/settings" />
        </Section>
        ...
        <Section title="Activity">
          ...
          >
            <span className="flex items-center gap-2 font-semibold"><FaClockRotateLeft /> Booking history</span>
          ...
          <Link
            ...
            className="flex items-center justify-between rounded-xl bg-white/80 px-4 py-3 text-sm hover:bg-white"
          >
            <span className="flex items-center gap-2 font-semibold"><FaHeart /> Favorite routes</span>
            <span className="text-orange-500">›</span>
          </Link>
        </Section>
      </div>
